...
% Visibility in simple planar polygons can be defined as: given a polygon $P \subset \mathbb R^2$, a point (guard) $p \in P$ \textit{sees} a point $q \in P$ if the line segment $\overline{pq} \subseteq P$. Thus, the points that are visible from $p$ form the visibility polygon (region) $Vis(p)$.

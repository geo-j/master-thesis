...
For our experiments, we will be using an exponentially increasing step size. Ths will allow us to search a larger space of position possibilities knowing the direction of the gradient descent. 

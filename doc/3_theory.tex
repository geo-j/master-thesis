...
\begin{align}
    \text{Area}_{\triangle_2}(g_1) &= \text{Area}_{\triangle_1 + \triangle_2}(g) - \text{Area}_{\triangle_2}(g) \nonumber \\
...
\begin{align*}
    \text{Area}_{\triangle_1}(g_1) &= \text{Area}_{\triangle_1 + \triangle_2}(g) - \text{Area}_{\triangle_1}(g) \\
...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width = \textwidth]{gradient.pdf}
        \caption{No momentum.}
        \label{fig:theory_no_momentum}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width = \textwidth]{theory/momentum.pdf}
...
\begin{figure}[h!]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width = \textwidth]{theory/reflex_area_to_vertex.pdf}

...
Lastly, it would be worth exploring how the algorithm would benefit from a different implementation. Namely, using another programming language like Python and other libraries which are better documented and more reliable to use.

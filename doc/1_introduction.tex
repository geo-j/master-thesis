...
\begin{figure}[h!]
    ...
    \caption{Example of an Art Gallery Problem instance with polygon $P$ guarded by 2 points. The visibility area $Vis(g)$ is emphasised in pink.}
    \label{fig:art}
\end{figure}

...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width = \textwidth]{literature/asano7.pdf}
		\caption{$a_2$ is added to the empty $\mathit{Vis}(g)$ such \\ that $\mathit{Vis}(g) = \{a_2\}$.}
		\label{fig:asano1}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width = \textwidth]{literature/asano1.pdf}
	...
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width = \textwidth]{literature/asano2.pdf}
	...
	\hfill
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width = \textwidth]{literature/asano3.pdf}
	...
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width = \textwidth]{literature/asano4.pdf}
	...
	\hfill
	\begin{subfigure}{0.45\textwidth}
		\includegraphics*[width = \textwidth]{literature/asano5.pdf}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width = 0.6\textwidth]{literature/asano6.pdf}

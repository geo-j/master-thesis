...
In terms of results on the real-world polygons, the Triangular Expansion algorithm has a 2-factor improved performance when compared to Asano's algorithm, and performs ``one order of magnitude'' faster than Joe and Simpson's algorithm. For the worst-case scenario, Asano's algorithm outperforms the Triangular Expansion algorithm with increasing input complexity.

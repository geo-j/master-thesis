...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics{literature/ForcingLine.pdf}
    ...
    \begin{subfigure}{0.65\textwidth}
        \centering
        \includegraphics{literature/DisjointTriangleRegions2.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics{literature/fig-6.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics{literature/RectilinearPolygonComplete4.pdf}

...
\begin{figure}[h!]
    \centering
    \includegraphics[width = \textwidth]{literature/fig-12.pdf}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{literature/ForcingLine.pdf}
    ...
    \begin{subfigure}{0.65\textwidth}
        \centering
        \includegraphics[width=\textwidth]{literature/DisjointTriangleRegions2.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{literature/fig-6.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{literature/RectilinearPolygonComplete4.pdf}
